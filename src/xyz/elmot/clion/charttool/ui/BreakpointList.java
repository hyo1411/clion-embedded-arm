...
public class BreakpointList extends JBTable implements XBreakpointListener<XBreakpoint<?>> {
    ...
    private class BreakpointModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                default:
                    ...
                    switch (columnIndex) {
                        case 2:
                            return lineState.clearChart;
                        case 3:
                            return lineState.sample;
                        case 4:
                            return lineState.autoResume;
                        default:
                            return false;
                    }
            }
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                case 2:
                    lineState.clearChart = Boolean.TRUE.equals(aValue);
                    break;
                case 3:
                    lineState.sample = Boolean.TRUE.equals(aValue);
                    break;
                case 4:
                    lineState.autoResume = Boolean.TRUE.equals(aValue);
                    break;
            }
        }
    }
